...
| `POS_BACKUP_DIR` | `./data/backup` | folder snapshot database ditulis (#10) |
| `POS_BACKUP_RETENTION_DAYS` | `7` | berapa hari snapshot disimpan sebelum yang terlama dihapus |
